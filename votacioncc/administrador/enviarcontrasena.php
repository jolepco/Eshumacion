...
$mail->Subject = 'VOTACIÓN VIRTUAL - REPRESENTANTES COMITÉ DE CONVIVENCIA LABORAL';
	
$html = '
	<p>Señor(a)</br>
	<b>'. utf8_encode($row['nombres']).' '.utf8_encode($row['apellidos']). '</b></br>
	En cumplimiento a la Resolución 2154 del 18 de noviembre de 2020, por medio de las cuales se convoca a la Elección de los Representantes al Comité de Convivencia Laboral, lo(a) invitamos a votar por el(la) candidato(a) de su elección, el 17 de diciembre de 2020, en el horario de 8:00 a.m. a 4:30 p.m.</br>
	<b>Para ingresar a registrar su voto, ingrese a través del siguiente enlace: </b></br>
	<a href="https://tramitesenlinea.saludcapital.gov.co/votacioncc/" target="_blank">Votación Virtual</a></br>
