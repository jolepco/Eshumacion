...
echo '<h2>SECRETARÍA DISTRITAL DE SALUD <br />VOTACIÓN VIRTUAL - REPRESENTANTES COMITÉ DE CONVIVENCIA LABORAL<br /></h2>';
        ...
        if ((cambia_mayuscula($grados[$row['grado']])==cambia_mayuscula($row5['nombre']))  or ($vrep==0)) {
			...
			if ($row8[0]>0) {
                ...
                echo '<div align="center">';
    			echo '<table style="font-weight:bold";>';
				echo '<thead><tr><th colspan="'.$row8[0].'" class="vto";>CANDIDATOS A REPRESENTANTES COMITÉ DE CONVIVENCIA LABORAL</th></tr></thead>';
