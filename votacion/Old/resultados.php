...
if(isset($_COOKIE['VotaDatAdmin'])) {
	...
	echo '<h2>RESULTADOS DE LAS VOTACIONES - 2020</h2>';

	$resp5=mysqli_query($link,"select * from categorias");
	while($row5 = mysqli_fetch_array($resp5)) {
	
		echo '<div align="center">';
		echo '<p class="txtinicial">RESULTADOS ELECCIÓN VIRTUAL DE REPRESENTANTES AL COMITÉ DE RECREACIÓN Y DEPORTES DE LA SECRETARÍA DISTRITAL DE SALUD - 2020</p>';
		echo '<table>';
