...
if ($_COOKIE['VotaDatAdmin']==1) {
	//****Agregar nuevo servidor*******
		if (isset($_POST['envia_estudiante'])) {
			...
			$cons_sql  = sprintf("INSERT INTO estudiantes(grado,nombres,apellidos,documento,clave,correo) VALUES(%d,%s,%s,%s,%s)", $fgrado, comillas($fnom_est),comillas($fape_est),comillas($fdoc_est),comillas($fclave_est),comillas($doc_est));
