...
echo '<h2>SECRETARÍA DISTRITAL DE SALUD <br />VOTACIÓN VIRTUAL - REPRESENTANTES ANTE COMISIÓN DE PERSONAL<br /></h2>';
        ...
        if ((cambia_mayuscula($grados[$row['grado']])==cambia_mayuscula($row5['nombre']))  or ($vrep==0)) {
			...
			if ($row8[0]>0) {
                ...
                echo '<div align="center">';
    			echo '<table style="font-weight:bold";>';
				echo '<thead><tr><th colspan="'.$row8[0].'" class="vto";>CANDIDATOS COMISIÓN DE PERSONAL</th></tr></thead>';
    ...
    include_once("encabezado.html");
	print "<strong>EL SISTEMA DE VOTACIÓN VIRTUAL - REPRESENTANTES ANTE LA COMISIÓN DE PERSONAL - ESTA INACTIVO</strong><br />";
    print "Fecha y hora de votación: Agosto 9 de 2021 - De 7:30a.m. a 4:00p.m.</div></body></html>";
}
mysqli_close($link);
?>
