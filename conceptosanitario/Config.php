...
//BD PRUEBAS SIVIGILA
define('servidorSQL','172.16.1.23\PRUEBASSQL2014, 27849'); 
define('usuarioSQL','UsuarioIVCSDS');
define('claveSQL','Brsageco2019');
define('bdSQL','vigia_produccion');

//BD PRODUCCION SIVIGILA
//   define('servidorSQL','172.16.0.227\VDBSQLA, 46782');
//  define('usuarioSQL','usrApp_Autorregulacion');
//   define('claveSQL','Autorregulacion2019$$');
