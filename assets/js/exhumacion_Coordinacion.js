...
$(document).ready(function() {
    ...
    var send = $.post("<?php echo base_url('Validacion/visualizarPDF')?>", {idl: idlic,difunto:difunto,cementerio:cementerio,licenciai:licenciai,fecha:fecha});
        ...
        if ($("#resultado_validacion").val() != '') {
            ...
            if ($("#resultado_validacion").val() == 2) {
                $("#div_masinformacion").show();
				        $("#div_guardar").show();
				        $("#div_actualizarInh").show();
                $("#aprobado").hide();
				        $("#div_devolver").hide();
				        $("#div_preliminar").hide();
                $("#div_rechazado").hide();
            } else if ($("#resultado_validacion").val() == 7) {
                $("#aprobado").show();
				        $("#div_preliminar").show();
				        $("#div_guardar").show();
			          $("#div_actualizarInh").show();
                ...
                $("#aprobado").hide();
				        $("#div_devolver").hide();
				        $("#div_preliminar").hide();
            } else if ($("#resultado_validacion").val() == 0) {
				        $("#div_actualizarInh").show();
                $("#div_rechazado").hide();
                $("#div_masinformacion").hide();
                $("#aprobado").hide();
...
$("#p_nombre, #s_nombre, #p_apellido, #s_apellido, #nombre_difunto, #cementerio, #observaciones, #parentescoOTRO, #r_social, #p_nombrerl, #s_nombrerl, #p_apellidorl, #s_apellidorl, #otrodocumentofallecido, #aliasfallecido, #p_nombrefallecido, #s_nombrefallecido, #p_apellidofallecido, #s_apellidofallecido, #nombrecementerio ").on("keypress", function () {
       $input=$(this);
       setTimeout(function () {
