...
$(document).ready(function() {
    ...
    var $signupFormLogin = $( '#form-login' );

    $signupFormLogin.validationEngine({
	...
	$signupFormLogin.submit(function() {
        var $resultado=$signupFormLogin.validationEngine("validate");
    ...
    $("#nacionalidad").change(function(){
        if($("#nacionalidad").val() == '170'){
            $("#div_ciudad_col").show();
			$("#div_ciudad_col2").show();
            $("#div_ciudad_otros").hide();
			$("#departamento").attr('required',true);
			$("#ciudad_nacimiento_otro").attr('required',false);
			$("#ciudad_nacimiento").attr('required',true);

        }else{
            $("#div_ciudad_col").hide();
			$("#div_ciudad_col2").hide();
            $("#div_ciudad_otros").show();
			$("#departamento").attr('required',false);
			$("#ciudad_nacimiento_otro").attr('required',true);
			$("#ciudad_nacimiento").attr('required',false);
    ...
    $("#depa_resi").change(function () {
           $("#depa_resi option:selected").each(function () {
            ...
            if(departamento == '3'){
        				...
        				$("#d_placa").val('');
        				$("#direccion_per").val('');
						$("#div_zona_bogota").hide();
						$("#estadongeo").hide();
						$("#div_zona_bogota2").hide();
						$("#localidadgeo").hide();
						$("#localidadngeo").hide();
						$("#upzgeo").hide();
						$("#upzngeo").hide();
	...
	$("#btn_direccion").click(function () {
		if($("#d_viap").val() == null || $("#d_num1").val() == '' || $("#d_num2").val() == '' || $("#d_placa").val() == ''){
	...
	$("#fecha_nacimiento").change(function () {
		...
		if (mesesPaciente<168){
			...
			alertify.alert("Novedad en Fecha de Nacimiento","El sistema no permite el ingreso de la fecha de nacimiento, ya que la fecha de edad corresponde a un menor de edad y el tipo de documento corresponde a un mayor de edad con Cedula de Ciudadanía o Extranjería. Favor verificar los datos e intentarlo de nuevo.");
    ...
    $("#p_nombre, #s_nombre, #p_apellido, #s_apellido, #ciudad_nacimiento_otro, #r_social").on("keypress", function () {
       $input=$(this);
       setTimeout(function () {
    ...
    $(function(){ 
        $(".tratamiento").click(function () { 
            ...
            $.ajax ({
                type: 'POST',
                url: base_url +"registro/cargar_tratamiento",
                data: {'idRow': oID },
                cache: false,
