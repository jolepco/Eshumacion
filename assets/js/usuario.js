...
$(document).ready(function() {
    ...
    $("#btn_nacep2term").click(function () {
		...
		$("#formreg2").hide();
        $("#2termino").show();
        alertify.alert("Novedad en Aceptar Términos:","Los presentes términos son pre-requisito para registrar el trámite, si tiene alguna inquietud sobre los términos mencionados agradecemos contactar telefónicamente o al correo electrónico contactenos@saludcapital.gov.co ");
    });
    ...
    $("#tipo_titulo").change(function(){
        if($("#tipo_titulo").val() == '1'){
			...
			$("#div_extranjero3").hide();
			$("#div_extranjero4").hide();
			$("#div_extranjero5").hide();
			$("#div_extranjero6").hide();
			$("#div_extranjero7").hide();
			$("#div_extranjero8").hide();
			$("#div_tarjeta").hide();
            $("#div_archivos_extranjero").hide();
			$("#pdf_resolucion").attr('required',false);
        }else{
            $("#div_nacional").hide();
			$("#div_nacional2").hide();
			$("#div_nacional3").hide();
			...
			$("#div_extranjero3").show();
			$("#div_extranjero4").show();
			$("#div_extranjero5").show();
			$("#div_extranjero6").show();
			$("#div_extranjero7").show();
			$("#div_extranjero8").show();
    ...
    $( "#fechaInh" ).datepicker({
     ...
     $('#tabla_mistramitesEXH').DataTable({
        language: {
            search:         "Buscar:",
            lengthMenu:    "Ver _MENU_ registros",
            info:           "Viendo _START_ a _END_ de _TOTAL_ entradas",
...
function solicitaProrroga(id_tramite){

	 alertify.confirm('Solicitar prorroga', 'Esta seguro que desea solicitar una prorroga por 20 días adicionales para poder subsanar el trámite?', 
	 function(){ 
		
		location.replace(base_url + "usuario/solicitarProrroga/" + id_tramite);
		
		/*$.post( base_url + "usuario/solicitarProrroga", {
 ...
 function anularTramite(id_tramite){

	 alertify.confirm('Anular trámite', 'Esta seguro que desea el trámite, si selecciona Si no puede continuar con este trámite?', 
	 function(){ 
		
		location.replace(base_url + "usuario/anularTramite/" + id_tramite);
