...
$(function() {
      ...
      serverSide: true,
        ...
        columns: [
            ...
            { 'data': 'NOMBRE_RAZON_SOCIAL' },
           	{ 'data': 'BASE_GRAVABLE_NETA' },         
			{ 'data': 'TOTAL_INGRESOS_BRUTOS_X_DISTRITO' },
        { 'data': 'VALOR_RETEN_INDUSYCOMERCIO' },
			{ 'data': 'DEDUCCIONES_EXENCIONES_ACN' }
    ...
    $('#btn-enviar').on("click", function (e) {
        ...
        var cedula = $("#num_identif").val();
          var tipo_identif = $("#tipo_ident").val();
     /*   var contrato = $("#contrato").val();
      ...
      /*  if(!contrato){contrato=1}*/
        ...
        if(cedula.length > 0 /*&& cuenta.length > 0*/) {
            window.location = base_url + 'consulta/generarPlano/'+tipo_identif+'/'+cedula/*+'/'+contrato+'/'+cuenta*/;
       } else {
            alert("No hay datos");
        }
    });
	...
	$('#btn-buscar').on("click", function () {		
	 ...
	 $.fn.buscarUsuarios = function () {
        ...
        tabla_listado.ajax.url('consulta/listadoJson/' + frm.join('/')).load(); 
