...
$mail->SMTPAuth = false;
$mail->Username = "ssttalentohumano@saludcapital.gov.co"; // SMTP username
$mail->Password = "SSTBogota2020*"; // SMTP password
$mail->FromName = "Dirección de Gestión del Talento Humano";
$mail->From = "ssttalentohumano@saludcapital.gov.co";
$mail->AddAddress($destinatario, $nombrecompleto);               
$mail->WordWrap = 50;
$mail->CharSet = 'UTF-8';
$mail->IsHTML(true); // set email format to HTML
$mail->Subject = 'VOTACIÓN VIRTUAL - REPRESENTANTES COMITÉ PARITARIO DE SEGURIDAD Y SALUD EN EL TRABAJO COPASST 2021';
	
$html = '
	<p>Señor(a)</br>
	<b>'. utf8_encode($row['nombres']).' '.utf8_encode($row['apellidos']). '</b></br>
	En cumplimiento a la Resolución 241 de 22 de febrero de 2021, por medio de las cual se convoca a la Elección de los Representantes al Comité Paritario de Seguridad y Salud en el Trabajo COPASST, lo(a) invitamos a votar por el(la) candidato(a) de su elección, el 26 de marzo de 2021, en el horario de 7:30 a.m. a 4:00 p.m. </br>	
	<b>Para ingresar a registrar su voto, ingrese a través del siguiente enlace: </b></br>
	<a href="https://tramitesenlinea.saludcapital.gov.co/votacioncopasst/" target="_blank">Votación Virtual</a></br>
