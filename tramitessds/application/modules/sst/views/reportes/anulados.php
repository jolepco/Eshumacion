...
?>
<form action="<?php echo base_url('sst/reportes/anulados/') ?>" method="post" class="form-horizontal">
		<div class="row block right" style="width:100%" >
			<div class="col-12 col-md-12 pl-4">
                <div class="subtitle">
                    <h2><b>Trámites Anulados.</b></h2>
...
<div class="col-12 col-md-3 pl-4">
            ...
            <div class="col-12 col-md-12">
					<table class="table" id="tabla_reporte" style="font-size:small;">
                        ...
                        <tbody>
                        <?php
                            if($tramites_anulados != NULL)
                            {
                                for($i=0;$i<count($tramites_anulados);$i++){                                    
                                ?>
                                <tr>
                                    <td>
                                        <?php 
                                            echo $tramites_anulados[$i]->id_tramite;
                                    ...
                                    <td>
                                        <?php echo $tramites_anulados[$i]->DescTipoIden." - ".$tramites_anulados[$i]->nume_identificacion?>
                                    </td>
                                    <td>
                                        <?php 
                                            if($tramites_anulados[$i]->tipo_identificacion == 5){
                                                echo $tramites_anulados[$i]->nombre_rs;
                                            }else{
                                                echo $tramites_anulados[$i]->p_nombre." ".$tramites_anulados[$i]->s_nombre." ".$tramites_anulados[$i]->p_apellido." ".$tramites_anulados[$i]->s_apellido;
                                            }
                                        ?>
                                    </td>                                
                                    <td>
                                        <?php 
                                            if($tramites_anulados[$i]->tipo_tramite == 1){
                                                echo "Primera Vez";
                                            }else if($tramites_anulados[$i]->tipo_tramite == 2){
                                                echo "Modificación";
                                            }else if($tramites_anulados[$i]->tipo_tramite == 3){
                                                echo "Renovación";
                                            }
                                        ?>                                    
                                    </td>
                                    <td>
                                        <?php echo $tramites_anulados[$i]->fecha_creacion?>
                                    </td>                               
                                    <td>
                                        <?php echo $tramites_anulados[$i]->descripcion?>
                                    </td>
                                    <td>
                                        <?php echo $tramites_anulados[$i]->fecha_estado?>
                                    </td>                                
                                    <td>
                                        <?php echo $tramites_anulados[$i]->observaciones?>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url('sst/reportes/ver_contenido/'.$tramites_anulados[$i]->id_tramite)?>">Ver</a>
                                    </td>
                                </tr>
                                <?php
                                }
