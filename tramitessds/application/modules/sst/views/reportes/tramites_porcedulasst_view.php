...
<form action="<?php echo base_url('sst/reportes/buscarporcedulaSST/') ?>" method="post" autocomplete="off" class="form-horizontal">
	<div class="row block right" style="width:100%" >
			<div class="col-12 col-md-12 pl-">
                <div class="subtitle">
					...
					<h3>Licencia de Seguridad y Salud en el Trabajo</h3>
                </div>
            </div>
		...
		<br>
			<table class="table" id="tabla_reporte" style="font-size:small;">
                ...
                if(!empty($tramitesinfo)){
                    ...
                    <tr>
                        <td>
                            <?php echo $tramitesinfo[$i]->id_tramite;?>
                        </td>
                        <td>
                        ...
                        <td>
                        <?php 
			if($tramitesinfo[$i]->tipo_identificacion == 5){
				echo $tramitesinfo[$i]->nombre_rs;
			}else{
				echo $tramitesinfo[$i]->p_nombre." ".$tramitesinfo[$i]->s_nombre." ".$tramitesinfo[$i]->p_apellido." ".$tramitesinfo[$i]->s_apellido;
			}
			?>
                        </td>
						<td>
                            <?php echo $tramitesinfo[$i]->fecha_creacion?>
                        </td>
						<td>
                        ...
                        <td>
							<center>
								<a href="<?php echo base_url('sst/reportes/visualizar_documentos/'.$tramitesinfo[$i]->id_tramite) ?>"  target="_blank">
