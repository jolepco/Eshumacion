                    ...
                    if($tramite_info->tipo_identificacion == 5)
                    {
                        ...
                        <div class="col-12 col-md-6 pl-4" id="div_1_1">
                            <div class="paragraph">
                                ...
                                <select id="tipo_iden_rl" name="tipo_iden_rl" class="form-control validate[required]" readonly>
                                    <option value="">Seleccione...</option>
                                    <?php
                                    for($i=0;$i<count($tipo_identificacion);$i++){
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select name="tipo_programa" id="tipo_programa" class="form-control form-control-sm validate[required]" readonly>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="tipo_titulo" id="tipo_titulo" class="form-control form-control-sm validate[required]" readonly>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="tipo_profesional" id="tipo_profesional" class="form-control form-control-sm validate[required]" readonly>                                
                                    ...
                                    if(count($total_sedes) > 0){
                                        ...
                                        <tr>                                            
                                            <td width="40%"> 
                                                ...
                                                <select name="perfiles-<?php echo $total_sedes[$ts]->contador?>" id="perfiles-<?php echo $total_sedes[$ts]->contador?>" class="form-control form-control-sm validate[required]" onchange="cargarCampos(this.id)" value="<?php $total_sedes[$ts]->id_perfil?>" readonly>
                                                    <option value=''>Seleccione...</option>
                                                    <?php
                                            ...
                                            <td width="40%"> 
                                                ...
                                                <select name="areas-<?php echo $total_sedes[$ts]->contador?>[]" id="areas-<?php echo $total_sedes[$ts]->contador?>" class="form-control form-control-sm validate[required] multipleSelect" multiple="multiple" readonly>
                                                <?php
                                        ...
                                        <tr>                                                                                
                                            <td width="40%"> 
                                                <label>Perfiles:</label>
                                                <select name="perfiles-1" id="perfiles-1" class="form-control form-control-sm validate[required]" onchange="cargarCampos(this.id)" readonly>
                                                    <option value=''>Seleccione...</option>
                                                    <?php
                                                    for($i=0;$i<count($perfiles_natural);$i++){
                                                        echo "<option value='".$perfiles_natural[$i]->id_perfil."'>".$perfiles_natural[$i]->desc_perfil."</option>";
                                            ...
                                            <td width="40%"> 
                                                <label>Campos de acción:</label>
                                                <select name="areas-1[]" id="areas-1" class="form-control form-control-sm validate[required] multipleSelect" multiple="multiple" readonly>
