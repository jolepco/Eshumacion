			...
			<td width='90%' class="justificado">
				<p class="continuacion">
					...
					if($tramite_info->tipo_identificacion == 5){
						?>
						Continuación de la Resolución No <?php echo $nume_resolucion?> de <?php echo date('d/m/Y')?> por  la cual se modifica 
						Licencia de Prestación de Servicios de Seguridad y Salud en el Trabajo a la entidad <?php echo $tramite_info->nombre_rs?>.	
						<?php
					}else{
						?>
						Continuación de la Resolución No <?php echo $nume_resolucion?> de <?php echo date('d/m/Y')?> por la cual se modifica Licencia de Prestación de Servicios de Seguridad y Salud en el Trabajo
						<?php
					}
					?>					
				</p>
      ...
      <div style="margin-left:45px;margin-right:35px;margin-top:-30px;">
		...
		<p class="justificado">
			<?php
				...
				?>
                    ...
                    <?php echo $tramite_info->nume_iden_rl?>, ha solicitado la modificación de la Licencia para Prestación de Servicios en Seguridad y Salud en el Trabajo N°. <?php echo $tramite_info->num_resolucion_anterior?> de  <?php echo $tramite_info->fecha_resolucion_anterior?> como Persona Jurídica por 
                    <?php                   
                        if($tramite_info->id_motivo_modificacion == 4){
							...
							echo $tramite_info->otro_modificacion;
						}
                    ?>.
				<?php
				}else{
				?>
					...
					identificado(a) con <?php echo $tramite_info->descTipoIden?> <?php echo $tramite_info->nume_identificacion?>, ha solicitado la modificación de la Licencia para prestación de servicios en Seguridad y Salud en el Trabajo N°. <?php echo $tramite_info->num_resolucion_anterior?> de  <?php echo $tramite_info->fecha_resolucion_anterior?> como persona natural por 
                    <?php                   
		...
		<?php
			...
			?>
				...
				<p class="justificado">
					...
					if($tramite_info->acta_visita == ''){
                    	...
                    	como consta en el acta de visita N°: <?php echo $tramite_info->acta_visita?> de fecha <?php echo $tramite_info->fecha_visita?>.	
						<?php
					}
					?>					
				</p>				
				...
				<p class="justificado">
					ARTICULO  PRIMERO:  Modificar  Licencia  de  Prestación  de  Servicios  en  Seguridad  y  Salud  en  el  Trabajo  a 
				...
				<p class="justificado">
					...
					?>
				<p class="justificado">
					ARTÍCULO TERCERO: La presente Modificación no afecta el término de diez (10) años, contados  a  partir  de  la  fecha  de expedición  de  
					la Resolución  N°. <?php echo $tramite_info->num_resolucion_articulo?>  de  <?php echo $tramite_info->fecha_resolucion_articulo?>
					es de carácter personal e intransferible, tendrá validez en todo el territorio nacional.
				</p>
				<p class="justificado">
			...
			?>
				...
				<p class="justificado">
					ARTICULO  PRIMERO:  Modificar  Licencia  de  Prestación  de  Servicios  en  Seguridad  y  Salud  en  el  Trabajo  a <?php echo $tramite_info->p_nombre." ".$tramite_info->s_nombre." ".$tramite_info->p_apellido." ".$tramite_info->s_apellido?>, 
				...
				<p class="justificado">
					...
					?>
				<p class="justificado">
					ARTÍCULO TERCERO: La presente Modificación no afecta el término de  vigencia  de  diez  (10)  años  contados  apartir  de  la  expedición  de  la  
					Resolución  <?php echo $tramite_info->num_resolucion_anterior?>  de  <?php echo $tramite_info->fecha_resolucion_anterior?>, es de carácter personal e intransferible, tendrá validez en todo el territorio nacional y 
