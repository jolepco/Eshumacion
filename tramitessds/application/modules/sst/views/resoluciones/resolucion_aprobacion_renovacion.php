			...
			<td width='90%' class="justificado">
				<p class="continuacion">
					...
					if($tramite_info->tipo_identificacion == 5){
						?>
						Continuación de la Resolución No <?php echo $nume_resolucion?> de <?php echo date('d/m/Y')?> por  la cual se Renueva  
						Licencia de Prestación de Servicios de Seguridad y Salud en el Trabajo a la entidad <?php echo $tramite_info->nombre_rs?>.	
						<?php
					}else{
						?>
						Continuación de la Resolución No <?php echo $nume_resolucion?> de <?php echo date('d/m/Y')?> por la cual se Renueva Licencia de Prestación de Servicios de Seguridad y Salud en el Trabajo
						<?php
					}
					?>					
				</p>
...
<div id="header">
  ...
  <div style="width:100%;">
      <div style="margin-left:45px;margin-right:35px;margin-top:-30px;">
		...
		<p class="centro">
			"Por la cual se Renueva Licencia de Prestación de Servicios en Seguridad y Salud en el Trabajo"
		</p>    
		<p class="centro">
		...
		<p class="justificado">
			<?php
				...
				?>
                    ...
                    <?php echo $tramite_info->nume_iden_rl?>, ha solicitado la renovación de la Licencia para Prestación de Servicios en Seguridad y Salud en el Trabajo como Persona Jurídica,    
					Resolución No. <?php echo $tramite_info->num_resolucion_anterior?>  de  <?php echo $tramite_info->fecha_resolucion_anterior?>, expedida por La Secretaria Distrital de Salud;                                      
				<?php
				}else{
				?>
					Que el (la) señor(a)  <?php echo $tramite_info->p_nombre." ".$tramite_info->s_nombre." ".$tramite_info->p_apellido." ".$tramite_info->s_apellido?>,  
					identificado(a) con <?php echo $tramite_info->descTipoIden?> <?php echo $tramite_info->nume_identificacion?>, ha solicitado la renovación de la Licencia para prestación de servicios en Seguridad y Salud en el Trabajo, 
					otorgada mediante Resolución No. <?php echo $tramite_info->num_resolucion_anterior?>  de  <?php echo $tramite_info->fecha_resolucion_anterior?>, expedida por La Secretaria Distrital de Salud;                    
				<?php
				}
			?>			
        </p>  
		...
		<?php
			...
			?>
				<p class="justificado">
                    ...
                    de  2012  expedida  por  el  Ministerio  de  Salud  y  Protección  Social  para  la modificación de la licencia de seguridad y salud en el trabajo.
				</p>
				<p class="justificado">
					<?php
					if($tramite_info->acta_visita == ''){
						?>
						Que en cumplimiento de lo ordenado en el artículo 8º de la Resolución 4502 de 2012 expedida por el Ministerio de Salud y Protección Social 
						se efectuó revisión documental con el propósito de verificar la información suministrada y garantizar la calidad en la prestación de los servicios de seguridad y salud en el trabajo
						<?php
					}else{
						?>
				...
				<p class="justificado">
					ARTICULO  PRIMERO:  Renovar  Licencia  de  Prestación  de  Servicios  en  Seguridad  y  Salud  en  el  Trabajo  a 
				...
				<p class="justificado">
					...
					?>
				<p class="justificado">
					ARTÍCULO TERCERO: La presente renovación de Licencia se concede por término de diez (10) años, es de carácter personal e intransferible, tendrá validez en todo el Territorio Nacional.
				</p>
				<p class="justificado">
			...
			?>
				...
				<p class="justificado">
					ARTICULO  PRIMERO:  Renovar  Licencia  de  Prestación  de  Servicios  en  Seguridad  y  Salud  en  el  Trabajo  a <?php echo $tramite_info->p_nombre." ".$tramite_info->s_nombre." ".$tramite_info->p_apellido." ".$tramite_info->s_apellido?>, 
				...
				<p class="justificado">
					ARTICULO SEGUNDO: La licencia renovada comprende la prestación de servicios en Seguridad y Salud en el Trabajo en las siguientes áreas o campos de acción:
				</p>
					<?php			
						for($ts=0;$ts<count($total_sedes);$ts++){
