...
<form class="form-horizontal" id="form_tramite" name="form_tramite" action="<?php echo base_url('sst/coordinacion/guardarEstado/'.$tramite_info->id_tramite)?>" method="post" enctype="multipart/form-data">
