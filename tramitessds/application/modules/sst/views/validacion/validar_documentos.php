    ...
    <div class="col-md-9">
        ...
        <?php
            if($tramite_info->tipo_tramite == 1){
                ...
                ?>
                <a href="<?php echo base_url('sst/validacion/cambiarTipoTramite/'.$tramite_info->id_tramite.'/2')?>" class="btn btn-sm btn-danger">Cambiar a Modificación</a>
                <a href="<?php echo base_url('sst/validacion/cambiarTipoTramite/'.$tramite_info->id_tramite.'/3')?>" class="btn btn-sm btn-warning">Cambiar a Renovación</a>
                <?php
            }else if($tramite_info->tipo_tramite == 2){
                echo '<b>Tipo de tramite: Modificación</b>';
                ?>
                <a href="<?php echo base_url('sst/validacion/cambiarTipoTramite/'.$tramite_info->id_tramite.'/1')?>" class="btn btn-sm btn-danger">Cambiar a Primera Vez</a>
                <a href="<?php echo base_url('sst/validacion/cambiarTipoTramite/'.$tramite_info->id_tramite.'/3')?>" class="btn btn-sm btn-warning">Cambiar a Renovación</a>
                <?php
                ...
                ?>
                <a href="<?php echo base_url('sst/validacion/cambiarTipoTramite/'.$tramite_info->id_tramite.'/1')?>" class="btn btn-sm btn-danger">Cambiar a Primera Vez</a>
                <a href="<?php echo base_url('sst/validacion/cambiarTipoTramite/'.$tramite_info->id_tramite.'/2')?>" class="btn btn-sm btn-warning">Cambiar a Modificación</a>
                <?php
            }
        ?>            
        </div>
        ...
        <div class="justify-content-between">
            ...
            <select name="id_motivo_modificacion" id="id_motivo_modificacion" class="form-control form-control-sm validate[required]">
        ...
        <div class="justify-content-between" id="div_modificacion_otro" style="display:<?php echo $display_otro?>">
            ...
            <input type="text" id="otro_modificacion" name="otro_modificacion" class="form-control form-control-sm validate[required]" value="<?php echo $tramite_info->otro_modificacion?>" >
        </div>
        <?php
        }
        ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {										
                                                        ?>
                                                        <!--<a href="<?php //echo base_url('/mt/sdb1/uploads/sst/'.$resultado_archivo->nombre)?>" target="_blank">
