...
<div id="page-wrapper">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="list-group-item-heading">
					<i class="fa fa-gear fa-fw"></i> &nbsp;  Certificado de Discapacidad
				</h4>
			</div>
		</div>
	</div>
	<div class="modal-body">
		...
		<form name="form" id="form" method="post" action="<?php echo base_url('/certificado_discapacidad/editar_documentos/')?>" enctype="multipart/form-data">
