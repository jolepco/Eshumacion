...
?>   
<form action="<?php echo base_url('certificado_discapacidad/reportes/1') ?>" method="post" class="form-horizontal">
	<div class="row block right" style="width:100%" >
			<div class="col-12 col-md-12 pl-">
                <div class="subtitle">
                    <h3><b>Reporte trámite Certificado de Discapacidad</b></h3>
				</div>
            </div>
		...
		<div class="col-12 col-md-12">
			<div class="col-md-2 col-md-offset-5">
				<a href="<?php echo base_url("certificado_discapacidad/generar_excel/1"); ?>" class="btn btn-primary btn-xl">Descargar Excel<span class="" aria-hidden="true"></a>
            </div>
        <br>
						...
						if (count($listado_soli) > 0) {
							for ($i = 0; $i < count($listado_soli); $i++) {
								...
								<tr>
									...
									<td>
										<?php echo $listado_soli[$i]->observaciones ?>
									</td>
									<td>
										<?php echo $listado_soli[$i]->fecha_registro ?>
									</td>
