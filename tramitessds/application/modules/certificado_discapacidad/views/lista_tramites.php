	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa heelchair"></i> Tr&aacute;mites pendientes
				</div>
						...
						<table width="100%" class="table table-striped table-bordered table-hover" id="dataTablesTramites">
							...
							<tbody>							
								...
								for($i=0; $i<=count($info)-1; $i++){
									...
									$idTramite=$info[$i]['id_tramite']+19722512-20131611;
									echo "<tr>";
										...
										echo "<td class='text-center'>";
											?>
											<a href="<?php echo base_url("certificado_discapacidad/aprobar_tramite/" . $idTramite); ?>" class="btn btn-success btn-xs">Validar <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></a>
											<?php
										echo "</td>";
										/**/
									echo "</tr>";
