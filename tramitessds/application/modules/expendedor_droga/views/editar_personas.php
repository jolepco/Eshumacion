<script type="text/javascript" src="<?php echo base_url("assets/js/expendedor/validate/editpersona.js"); ?>"></script>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group text-left">
					...
					<input type="text" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control" value="<?php echo $information?$newFecha_nacimiento:""; ?>" placeholder="mm/dd/aaaa" required>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label class="control-label" for="email">Correo electr&oacute;nico: *</label>
					<input type="text" id="email" name="email" class="form-control" value="<?php echo $information?$information->email:"00/00/0000"; ?>" placeholder="Correo" required>
				</div>
			</div>
		</div>
		<div class="row">
