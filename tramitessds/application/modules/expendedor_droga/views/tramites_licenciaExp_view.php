...
?>   
<form action="<?php echo base_url('expendedor_droga/reportes/1') ?>" method="post" class="form-horizontal">
	<div class="row block right" style="width:100%" >
			<div class="col-12 col-md-12 pl-">
                <div class="subtitle">
                    <h3><b>Reporte trámites Licencia Expendedor de Drogas</b></h3>
				</div>
            </div>
		...
		<div class="col-12 col-md-12">
			<div class="col-md-2 col-md-offset-5">
				<a href="<?php echo base_url("expendedor_droga/generar_excel/1"); ?>" class="btn btn-primary btn-xl">Descargar Excel<span class="" aria-hidden="true"></a>
            </div>
        <br>
