...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Tr&aacute;mite expendedor de droga
		<br><small>Recurso de reposici&oacute;n</small>
	</h4>
</div>
<div class="modal-body">
	<p class="text-danger text-left">Los campos con * son obligatorios.</p>
	<form name="form" id="form" method="post" action="<?php echo base_url('/expendedor_droga/registrar_reposicion/')?>" enctype="multipart/form-data">
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group text-left">
					<label class="control-label" for="observaciones">Escriba los motivos por el cual est&aacute; presetando el recurso da reposici&oacute;n:</label>
