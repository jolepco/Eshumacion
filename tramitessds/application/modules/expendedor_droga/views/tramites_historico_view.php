...
?>   
<form action="<?php echo base_url('expendedor_droga/reportes/2') ?>" method="post" class="form-horizontal">
	<div class="row block right" style="width:100%" >
			<div class="col-12 col-md-12 pl-">
                <div class="subtitle">
                    <h3><b>Reporte histórico trámites Licencia Expendedor de Drogasss</b></h3>
				</div>
            </div>
		...
		<div class="col-12 col-md-12">
			<div class="col-md-2 col-md-offset-5">
				<a href="<?php echo base_url("expendedor_droga/generar_excel/2"); ?>" class="btn btn-primary btn-xl">Descargar Excel<span class="" aria-hidden="true"></a>
            </div>
		<br>
					...
					<tbody>
						...
						if (count($listado_soli) > 0) {
							for ($i = 0; $i < count($listado_soli); $i++) {
								...
								<tr>
									<td>
										&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $listado_soli[$i]->id_expdrogas_tramite; ?>
									</td>
									<td>
									...
									<td>
										...
										if ($listado_soli[$i]->id_estado == 4) { 
											$resolucion="expendedor_droga/abrir_resolucion_pdf/".$listado_soli[$i]->id_usuario;
