      ...
      <div style="margin-left:45px;margin-right:35px;margin-top:-30px;">
        ...
        <p align="center">
            <b><em>Resolución No. <?php echo $nume_resolucion?> del <?php echo $dia." de ".$mes." de ".$anio;?><br>
              "POR LA CUAL SE ACLARA  UNA CREDENCIAL DE EXPENDEDOR DE DROGAS"<br>
		...
		?>
        <p align="justify">Que mediante la resolución No. <?php echo $nume_resolucion?> del <?php echo $dia." de ".$mes." de ".$anio;?> la Secretaria Distrital de Salud de Bogotá D.C, otorgo la autorización como EXPENDEDOR DE DROGAS, que lo autoriza para dirigir el establecimiento denominado DROGUERIA a <?php echo $nombre_rl?>, identificado(a) con <?php 	echo $tipo_iden_rl?> número <?php echo $info[0]->nume_identificacion?>.</p>
        <p align="justify">
        <?php echo $info[0]->obs_aclaracion; ?>
        </p>
		<p align="justify">
			Que estudiada la documentación presentada por el solicitante este cumple con los requisitos establecidos en las normas legales vigentes;
		</p> 
		<p align="center">
			En virtud de lo expuesto este Despacho.<br>
            <b><em>RESUELVE</em></b>
      </p>
	    <p align="justify">
	    	<b>ARTÍCULO PRIMERO:</b> Aclarar la resolución No <?php echo $nume_resolucion?> del <?php echo $dia." de ".$mes." de ".$anio;?>, expedida por la Secretaria Distrital de Salud de Bogotá D.C en el sentido de consignar <?php echo $info[0]->obs_articulo1; ?>.
	        </p>
	        <p align="justify"><b>ARTÍCULO SEGUNDO:</b> Las demás Partes de la resolución No <?php echo $nume_resolucion?> del <?php echo $dia." de ".$mes." de ".$anio;?> expedida por la Secretaria Distrital de Salud de Bogotá D.C se mantienen en firme.
        </p>
        <p align="justify">
