							...
							<tbody>							
								...
								for($i=0; $i<=count($info)-1; $i++){
									...
									echo "<tr>";
										...
										echo "<td class='text-center'>";
											?>
											<a href="<?php echo base_url("plazas/aprobar_tramite/" . $idTramite); ?>" class="btn btn-success btn-xs">Validar <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></a>
											<?php
										echo "</td>";
										/**/
									echo "</tr>";
