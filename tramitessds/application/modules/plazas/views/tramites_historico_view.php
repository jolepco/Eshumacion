...
<form action="<?php echo base_url('plazas/reportes/1') ?>" method="post" class="form-horizontal">
	<div class="row block right" style="width:100%" >
			<div class="col-12 col-md-12 pl-">
                <div class="subtitle">
                    <h3><b>Reporte histórico trámite Autorización de Plazas Servicio Social Obligatoro</b></h3>
				</div>
            </div>
		...
		<br>
			...
			<p>La consulta y el reporte de tr&aacute;mites que se han solicitado con su último estado de gesti&oacute;n, es por rango de fecha de acuerdo a la fecha del registro generada por el sistema.<br>
 ...
 <script type="text/javascript">
   ...
   window.location.href =base_url+'plazas/generar_excel/2?fecha_i='+fecha_i+'&fecha_f='+fecha_f;  
