					...
					<table class="table" id="tabla_tramites" style="font-size:small;">
                        ...
                        if(count($rayosx_pendientes)>0){
                            ...
                            <tr>
                                ...
                                <td>
                                  <?php
                                  if($rayosx_pendientes[$i]->estado == 5 || $rayosx_pendientes[$i]->estado == 18 || $rayosx_pendientes[$i]->estado == 6 || $rayosx_pendientes[$i]->estado == 7){
                                  ...
                                  }else if($rayosx_pendientes[$i]->estado == 19 || $rayosx_pendientes[$i]->estado == 41 || $rayosx_pendientes[$i]->estado == 21 || $rayosx_pendientes[$i]->estado == 22  || $rayosx_pendientes[$i]->estado == 23){

                                    $resultEstado = $this->xindustrial_model->consultar_estado_tramite($rayosx_pendientes[$i]->id, $rayosx_pendientes[$i]->estado);

                                    if($resultEstado && $resultEstado->fecha_estado != ''){
								...
								<td>
                                   <?php
											...
											$estadosCoordinador = array(5,6,7,18,19,21,22,23);
											if(in_array($rayosx_pendientes[$i]->estado, $estadosCoordinador)){
                                                ?>
                                                <center>
                                                  <a href="<?php echo base_url('xindustrial/coordinacion/validar_documentos_rx/'.$rayosx_pendientes[$i]->id)?>">
