...
<div class="col-6 col-md-6 table-responsive" style="<?php echo $display_form4_1;?>">
 <h4><b>Documentos Categoría I</b></h4>
	...
	<div class="col-md-12">
	   ...
	   <textarea id="observaciones_item6" name="observaciones_item6" placeholder="Observaciones Documentos adjuntos" class="form-control input-md" rows="9"><?php if(isset($observacionesTramite->observaciones6)){echo $observacionesTramite->observaciones6;}?></textarea>
	</div>
</div>
