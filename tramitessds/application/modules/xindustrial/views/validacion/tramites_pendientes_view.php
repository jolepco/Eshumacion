					...
					<table class="table" id="tabla_tramites" style="font-size:small;">
                        ...
                        if(count($rayosx_pendientes)>0){
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
									if($rayosx_pendientes[$i]->estado == 2 || $rayosx_pendientes[$i]->estado == 17){
									...
									}else if($rayosx_pendientes[$i]->estado == 14 || $rayosx_pendientes[$i]->estado == 20){

										$resultEstado = $this->xindustrial_model->consultar_estado_tramite($rayosx_pendientes[$i]->id, 13);
								...
								<td>
                                   <?php
                                            ...
                                            if($rayosx_pendientes[$i]->estado == 2 || $rayosx_pendientes[$i]->estado == 17){
                                                ?>
                                                <center>
                                                  <a href="<?php echo base_url('xindustrial/validacion/validar_documentos_rx/'.$rayosx_pendientes[$i]->id)?>">
                                                    <img src="<?php echo base_url('assets/imgs/aprobar.png')?>" width="40px">
                                                    <br>Validar Informaci&oacute;n
                                                    </a>
                                                </center>
                                                <?php
											                       }else if($rayosx_pendientes[$i]->estado == 14 || $rayosx_pendientes[$i]->estado == 20 || $rayosx_pendientes[$i]->estado == 41){
												                     ?>
                                                <center>
                                                  <a href="<?php echo base_url('xindustrial/validacion/validar_documentos_rx/'.$rayosx_pendientes[$i]->id)?>">
                                                    <img src="<?php echo base_url('assets/imgs/aprobar.png')?>" width="40px">
