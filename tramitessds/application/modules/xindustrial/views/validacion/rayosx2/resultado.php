	...
	<div class="col-md-12">
		...
		<div class="row" id="div_obs_resultado" style="display:none">
			...
			<div class="col-md-12 text-center m-3" id="div_preliminar" style="display:none">
				...
				?>
				<button name="preliminar" id="preliminar" class="btngovco" type="submit" role="button" formtarget="_blank">Preliminar</button>
				<?php
				 }?>
			</div>
			<div class="col-md-12 text-center m-3">
				<button name="guardar" id="guardar" class="btngovco" type="submit" role="button" onclick="this.disabled">Guardar</button>
			</div>
		</div>
