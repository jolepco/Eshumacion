<div class="row">
		...
		if($tramites_pendientes->tipo_identificacion == 5){
			...
			<div class="col-md-6 pl-4" id="div_1_13">
				<div class="paragraph">
					...
					<input id="nombre_rs" name="nombre_rs" required placeholder="Razón Social" class="form-control validate[required, maxSize[250]]" type="text" value="<?php echo $tramites_pendientes->nombre_rs?>" readonly>
				</div>
			</div>
			<?php
		}else{
			...
			<div class="col-md-6 pl-4" id="div_1_3">
				<div class="paragraph">
					...
					<input id="p_nombre" name="p_nombre" required placeholder="Primer Nombre" class="form-control validate[required, maxSize[80]]" type="text" value="<?php echo $tramites_pendientes->p_nombre?>" readonly>
				</div>
			</div>
			<div class="col-md-6 pl-4" id="div_1_4">
				<div class="paragraph">
					<label for=""><b>Segundo nombre:</b></label>
					<input id="s_nombre" name="s_nombre" placeholder="Segundo Nombre" class="form-control validate[maxSize[80]]" type="text" value="<?php echo $tramites_pendientes->s_nombre?>" readonly>
				</div>
			</div>
			<div class="col-md-6 pl-4" id="div_1_5">
				<div class="paragraph">
					<label for=""><b>Primer apellido:</b></label>
					<input id="p_apellido" name="p_apellido" required placeholder="Primer apellido" class="form-control validate[required, maxSize[80]]" type="text" value="<?php echo $tramites_pendientes->p_apellido?>" readonly>
				</div>
			</div>
			<div class="col-md-6 pl-4" id="div_1_6">
				<div class="paragraph">
					<label for=""><b>Segundo apellido:</b></label>
					<input id="s_apellido" name="s_apellido" placeholder="Segundo apellido" class="form-control validate[maxSize[80]]" type="text" value="<?php echo $tramites_pendientes->s_apellido?>" readonly>
				</div>
			</div>
			<?php
		}
	...
	<div class="col-md-6 pl-4" id="div_1_7">
		<div class="paragraph">
			...
			<input id="telefono_celular" name="telefono_celular" placeholder="Teléfono celular" class="form-control input-md validate[required, maxSize[10], custom[number]]" type="text" value="<?php echo $tramites_pendientes->telefono_celular?>" readonly>
		</div>
	</div>
	<div class="col-md-6 pl-4" id="div_1_8">
		<div class="paragraph">
			<label for=""><b>Teléfono fijo:</b></label>
			<input id="telefono_fijo" name="telefono_fijo" placeholder="Teléfono fijo" class="form-control input-md validate[required, maxSize[10], custom[number]]" type="text" value="<?php echo $tramites_pendientes->telefono_fijo?>" readonly>
		</div>
	</div>
	<div class="col-md-6 pl-4" id="div_1_9">
		<div class="paragraph">
			<label for=""><b>Correo electr&oacute;nico:</b></label>
			<input id="email" name="email" required placeholder="Correo eletrónico " class="form-control input-md validate[required, custom[email]]" required="" type="text" value="<?php echo $tramites_pendientes->email?>" readonly>
		</div>
	</div>
	<?php
	if($tramites_pendientes->tipo_identificacion == 5)
	{
		...
		<div class="col-md-6 pl-4" id="div_1_1">
			<div class="paragraph">
				...
				<select id="tipo_iden_rl" name="tipo_iden_rl" required class="form-control validate[required]" readonly>
					<option value="">Seleccione...</option>
					<?php
					for($i=0;$i<count($tipo_identificacion);$i++){
		...
		<div class="col-md-6 pl-4" id="div_1_2">
			<div class="paragraph">
				...
				<input id="nume_iden_rl" name="nume_iden_rl" required placeholder="Número de documento de identidad" class="form-control input-md validate[required, maxSize[11], custom[number]]" required="" type="text" value="<?php echo $tramites_pendientes->nume_iden_rl?>" style="width:100%;" readonly>
			</div>
		</div>
		<div class="col-md-6 pl-4" id="div_1_3">
			<div class="paragraph">
	...
	<div class="col-md-6 pl-4" id="div_1_10">
		<div class="paragraph">
			...
			<input id="fecha_nacimiento" name="fecha_nacimiento" placeholder="Fecha Nacimiento" class="form-control input-md validate[required]" type="date" value="<?php echo $tramites_pendientes->fecha_nacimiento?>" autocomplete="off" readonly>
		</div>
	</div>
	<div class="col-md-6 pl-4" id="div_1_11">
		<div class="paragraph">
			<label for=""><b>Sexo:</b></label>
				<select id="sexo" name="sexo" class="form-control validate[required]" readonly>
					<option value="">Seleccione...</option>
	...
	<div class="col-md-6 pl-4" id="div_1_12">
		<div class="paragraph">
			<label for=""><b>Genero:</b></label>
				<select id="genero" name="genero" class="form-control validate[required]" readonly>
					<option value="">Seleccione...</option>
	...
	<div class="col-md-6 pl-4" id="div_1_13">
		<div class="paragraph">
			<label for=""><b>Orientaci&oacute;n:</b></label>
				<select id="orientacion" name="orientacion" class="form-control validate[required]" readonly>
					<option value="">Seleccione...</option>
	...
	<div class="col-md-6 pl-4" id="div_1_14">
		<div class="paragraph">
			<label for=""><b>Etnia:</b></label>
				<select id="etnia" name="etnia" class="form-control validate[required]" readonly>
					<option value="">Seleccione...</option>
	...
	<div class="col-md-6 pl-4" id="div_1_15">
		<div class="paragraph">
			<label for=""><b>Estado Civil:</b></label>
				<select id="estado_civil" name="estado_civil" class="form-control" readonly>
					<option value="">Seleccione...</option>
	...
	<div class="col-md-6 pl-4" id="div_1_16">
		<div class="paragraph">
			<label for=""><b>Nivel Educativo:</b></label>
				<select id="tipo" name="nivel_educativo" class="form-control validate[required]" readonly>
					<option value="">Seleccione...</option>
