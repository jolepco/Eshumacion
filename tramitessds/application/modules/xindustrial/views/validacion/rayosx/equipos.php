...
<div class="row">
    ...
    <div id="div_3_2" class="col-md-12 table-responsive">
        ...
        for($i=0;$i<count($rayosxEquipo);$i++){
            ...
            <div class="modal" id="ex<?php echo $rayosxEquipo[$i]->id_equipo_rayosx?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <?php
                        ...
                        if($rayosxEquipo[$i]->fi_pruebas_caracterizacion != ''){
                            ...
                            if($fi_pruebas_caracterizacion){
                                ?>
                                <li><b>Programa de vigilancia pos mercado de los equipos generadores de radiación ionizante: </b><a href="<?php echo base_url('uploads/xindustrial/'.$fi_pruebas_caracterizacion->nombre);?>" target="_blank">Ver archivo</a></li>
                                <?php
                            }else{
                                ?>
