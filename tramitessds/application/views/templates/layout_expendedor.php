...
<html lang="es">
    ...
    <header>
		<div class="container2">
            ...
            <div class="last">
                        <?php 
                        $this->load->view('templates/menu_exp.php');
            ...
            <div class="row">
                <div id="container2">
                    ...
                    <div id="contenido">
                        ...
                        <!--<script src="<?php //echo base_url("assets/expendedor/tiny_mce/tiny_mce_src.js"); ?>"></script>-->
                        ...
                        <script src="<?php echo base_url('assets/js/expendedor/ready.js') ?>"></script>
                        <!--<script src="<?php //echo base_url('assets/js/expendedor/tinyMCE.js') ?>"></script>-->
                         ...
                         <script src="https://cdn.tiny.cloud/1/m0gb87ci1co3cy9z0srgy5fj36s1ktq9y7ftr60itaw2sszr/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
                    </div>
                </div>
            </div>
        </div>  
