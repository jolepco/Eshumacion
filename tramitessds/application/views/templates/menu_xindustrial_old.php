        ...
        if($this->session->userdata('perfil') == 2){
          ...
          <!--<li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<?php echo base_url('xindustrial/reportes/')?>">Dashboard</a>
                <a class="dropdown-item" href="<?php echo base_url('xindustrial/reportes/anulados')?>">Trámites Anulados</a>
                <a class="dropdown-item" href="<?php echo base_url('xindustrial/reportes/devueltos')?>">Trámites Devueltos</a>          
                <a class="dropdown-item" href="<?php echo base_url('xindustrial/reportes/licencias')?>">Licencias Generadas</a>          
              </div>
          </li> -->
