...
$(document).ready(function(){
  ...
  $("#btnSubmitAprobar").click(function(){
    ...
    if ($("#form_aprobar").valid() == true){
        ...
        $.ajax({
          type: "POST",
          url: base_url + "expendedor_droga/save_aprobar_validador",
          ...
          success: function(data){
            ...
            if( data.result )//true
            {
              ...
              $("#div_load").css("display", "none");
              $('#btnSubmitAprobar').removeAttr('disabled');
              location.href = base_url + "expendedor_droga/aprobar_tramite";
  ...
  //}
    ...
    $("#btnSubmitFirmar").click(function(){
       $.ajax({
          type: "POST",
          url: base_url + "expendedor_droga/enviar_resolucion",
          data: $("#form_aprobar").serialize(),
          dataType: "json",
          contentType: "application/x-www-form-urlencoded;charset=UTF-8",
          cache: false,
          ...
          if( data.result )//true
            {
              ...
              location.href = base_url + "expendedor_droga/tramites_pendientes";
              //location.reload();
            }
            else
            {
