$(document).ready(function(){
	...
	$("#resultado_validacion").change(function(){
        if($("#resultado_validacion").val() != ''){
			...
			if($("#resultado_validacion").val() == 2 || $("#resultado_validacion").val() == 3){
				$("#div_acta").show();
			}else{
				$("#div_acta").hide();
			}

			if($("#resultado_validacion").val() == 4 || $("#resultado_validacion").val() == 6 || $("#resultado_validacion").val() == 12){
				$("#div_preliminar").hide();
			}
	...
	$("#id_motivo_modificacion").change(function () {

		if($(this).val() == 10){
			$("#div_modificacion_otro").show();
		}else{
			$("#div_modificacion_otro").hide();
			$("#otro_modificacion").val('');
		}
