...
$(function(){ 
    $(".editar").click(function () { 
        ...
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/editar_tramite",
            data: {'idRow': oID},
            cache: false,
            success: function (data) {
                //  alert(url);
...
$(function(){ 
    $(".VerPDF").click(function () { 
        ...
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/cargar_modal_pdf",
            data: {'idRow': oID},
            cache: false,
            success: function (data) {
                $('#tablaDatos').html(data);
...
$(function(){ 
    $(".corregirPDF").click(function () { 
        ...
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/cargar_modal_editarpdf",
            data: {'idRow': oID },
            cache: false,
            success: function (data) {
...
$(function(){ 
    $(".editPersonales").click(function () { 
        var oID = $(this).attr("id");
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/modal_editpersona",
            data: {'idRow': oID },
            cache: false,
            success: function (data) {
                $('#tablaDatos').html(data);
...
$(function(){ 
    $(".editEncargado").click(function () { 
        var oID = $(this).attr("id");
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/modal_editencargado",
            data: {'idRow': oID },
            cache: false,
            success: function (data) {
                $('#tablaDatos').html(data);
...
$(function(){ 
    $(".editProyecto").click(function () { 
        ...
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/modal_editproyecto",
            data: {'idRow': oID },
            cache: false,
            success: function (data) {
                $('#tablaDatos').html(data);
...
$(function(){ 
    $(".auditoria").click(function () { 
        ...
        $.ajax ({
            type: 'POST',
            url: base_url +"plazas/ver_auditoria",
            data: {'idRow': oID },
            cache: false,
            success: function (data) {
                $('#tablaDatos').html(data);
