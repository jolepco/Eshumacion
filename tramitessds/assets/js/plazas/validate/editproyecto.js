...
$(document).ready(function(){
  ...
  $("#enc_pnombre").convertirMayuscula();
  $("#enc_snombre").convertirMayuscula();
  $("#enc_papellido").convertirMayuscula();
  $("#enc_sapellido").convertirMayuscula();
  $("#dire_resi").convertirMayuscula();
  $("#enc_telefono").bloquearTexto().maxlength(12);
  $("#enc_celular").bloquearTexto().maxlength(12);
  $("#enc_numiden").bloquearTexto().maxlength(18);
  ...
  $("#btnSubmittttttt").click(function(){
  ...
  /*if(!$("input.dependencia:checked[type=checkbox]").length>0){  //checked = $("input:checked[type=checkbox]").length;
    ...
    if ($("#formmmmmmmm").valid() == true){
        ...
        $.ajax({
          type: "POST",
          url: base_url + "plazas/save_editproyecto1111",
          data: $("#form").serialize(),
          dataType: "json",
          ...
          success: function(data){
            ...
            if( data.result )//true
            {
              ...
              $("#div_load").css("display", "none");
              $('#btnSubmit').removeAttr('disabled');
              location.href = base_url + "plazas/save_editproyecto2222";
